...
void Player1Turn();
void Player2Turn();
void CPUTurnDefensive();
void CPUTurnOffensive();
int CheckWin();
...
int main(int argc, char *argv[])
{
    ...
    SetColor(FOREGROUND_RED|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY);cout<<"Choose AI Style:"<<endl;
    SetColor(FOREGROUND_GREEN|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY);cout<<"\t1.) Defensive"<<endl;
    SetColor(FOREGROUND_BLUE|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY);cout<<"\t2.) Offensive"<<endl;
    SetColor(FOREGROUND_RED|FOREGROUND_GREEN|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY);cout<<"\t3.) Quit"<<endl;
    SetColor(FOREGROUND_RED|FOREGROUND_INTENSITY);cout<<"\t";cin>>AIStyle;
    if(AIStyle==3){cout<<"\tThanks for Playing!"<<endl;Delay(1000);return 0;}
    if(play==1)
    {
        for(int i=0;i=8;i++)
        {
            ...
            {
                DrawBoard();
                if(AIStyle==1){CPUTurnDefensive();}
                if(AIStyle==2){CPUTurnOffensive();}
...
void CPUTurnOffensive()
{
     //check for blocks
     //top line
     if(board[7]==O&&board[8]==O&&board[9]==E){board[9]=O;cout<<JACK_1<<endl;Delay(1000);return;}
     if(board[7]==O&&board[8]==E&&board[9]==O){board[8]=O;cout<<JACK_1<<endl;Delay(1000);return;}
     if(board[7]==E&&board[8]==O&&board[9]==O){board[7]=O;cout<<JACK_1<<endl;Delay(1000);return;}
     //middle line
     if(board[4]==O&&board[5]==O&&board[6]==E){board[6]=O;cout<<JACK_2<<endl;Delay(1000);return;}
     if(board[4]==O&&board[5]==E&&board[6]==O){board[5]=O;cout<<JACK_2<<endl;Delay(1000);return;}
     if(board[4]==E&&board[5]==O&&board[6]==O){board[4]=O;cout<<JACK_2<<endl;Delay(1000);return;}
     //bottom line
     if(board[1]==O&&board[2]==O&&board[3]==E){board[3]=O;cout<<JACK_3<<endl;Delay(1000);return;}
     if(board[1]==O&&board[2]==E&&board[3]==O){board[2]=O;cout<<JACK_3<<endl;Delay(1000);return;}
     if(board[1]==E&&board[2]==O&&board[3]==O){board[1]=O;cout<<JACK_3<<endl;Delay(1000);return;}
     //negative diagnol 
     if(board[7]==O&&board[5]==O&&board[3]==E){board[3]=O;cout<<JACK_4<<endl;Delay(1000);return;}
     if(board[7]==O&&board[5]==E&&board[3]==O){board[5]=O;cout<<JACK_4<<endl;Delay(1000);return;}
     if(board[7]==E&&board[5]==O&&board[3]==O){board[7]=O;cout<<JACK_4<<endl;Delay(1000);return;}
     //positive diagnol
     if(board[9]==O&&board[5]==O&&board[1]==E){board[1]=O;cout<<JACK_5<<endl;Delay(1000);return;}
     if(board[9]==O&&board[5]==E&&board[1]==O){board[5]=O;cout<<JACK_5<<endl;Delay(1000);return;}
     if(board[9]==E&&board[5]==O&&board[1]==O){board[9]=O;cout<<JACK_5<<endl;Delay(1000);return;}
     //left down
     if(board[7]==O&&board[4]==O&&board[1]==E){board[1]=O;cout<<JACK_6<<endl;Delay(1000);return;}
     if(board[7]==O&&board[4]==E&&board[1]==O){board[4]=O;cout<<JACK_6<<endl;Delay(1000);return;}
     if(board[7]==E&&board[4]==O&&board[1]==O){board[7]=O;cout<<JACK_6<<endl;Delay(1000);return;}
     //right down
     if(board[9]==O&&board[6]==O&&board[3]==E){board[3]=O;cout<<JACK_7<<endl;Delay(1000);return;}
     if(board[9]==O&&board[6]==E&&board[3]==O){board[6]=O;cout<<JACK_7<<endl;Delay(1000);return;}
     if(board[9]==E&&board[6]==O&&board[3]==O){board[9]=O;cout<<JACK_7<<endl;Delay(1000);return;}
     //middle down
     if(board[8]==O&&board[5]==O&&board[2]==E){board[2]=O;cout<<JACK_8<<endl;Delay(1000);return;}
     if(board[8]==O&&board[5]==E&&board[2]==O){board[5]=O;cout<<JACK_8<<endl;Delay(1000);return;}
     if(board[8]==E&&board[5]==O&&board[2]==O){board[8]=O;cout<<JACK_8<<endl;Delay(1000);return;}
     //can't find a block?
     if(board[7]==E){board[7]=O;cout<<JACK_9<<endl;Delay(1000);return;}
     if(board[4]==E){board[4]=O;cout<<JACK_9<<endl;Delay(1000);return;}
     if(board[1]==E){board[1]=O;cout<<JACK_9<<endl;Delay(1000);return;}
